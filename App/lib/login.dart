...
import 'package:huchao/main.dart';
...
var fireTime;
var numberCondition;
List FireAllCondition;
List numberAllCondition;
List doorAllCondition;
...
class _LoginPageState extends State<LoginPage> {
  ...
  getLastDoor() async{
    ...
    setState(() {
      doorDate = data1['data']['date'];
      doorTime = data1['data']['time'];
    });
  }
  getLastFire() async{
    Dio dio = Dio();
    ...
    setState(() {
      fireDate = data2['data']['date'];
      fireTime = data2['data']['time'];
    });
  }
  getLastNumber() async{
    Dio dio = Dio();
    ...
    print(response);
    var data3 = jsonDecode(response.toString());
    setState(() {
      numberCondition = data3["data"]["peoplenum"];
    });
  }
...
//            }
            Navigator.push(
              context,
              new MaterialPageRoute(builder: (context) => new Huchao()),
            );
            getLastDoor();
            getLastFire();
            getLastNumber();
